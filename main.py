...
from bot_sdk import BotRunner, setup_logging
from bot_sdk.config import AppConfig, load_config
from bot_sdk.console import run_console
from bot_sdk.db.cli import make_bot_migrations, run_bot_migrations
from bot_sdk.loader import BotSpec, discover_bot_factories
...
def _run_bots(config_path: str = "bots.yaml", verbose: bool = False) -> None:
    ...
    if not config_path.exists():
        raise FileNotFoundError(f"{config_path} not found; please create it to list bots to launch")
